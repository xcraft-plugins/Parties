...
public abstract class ConfigMain extends ConfigurationFile {
	...
	public static String		ADDITIONAL_PLACEHOLDER_LEADER_NAME;
	public static String		ADDITIONAL_PLACEHOLDER_LEADER_UUID;
	public static String		ADDITIONAL_PLACEHOLDER_LIST_RANK;
	public static String		ADDITIONAL_PLACEHOLDER_LIST_RANK_NUMBER;
	public static String		ADDITIONAL_PLACEHOLDER_LIST_RANK_ONLINE;
	public static String		ADDITIONAL_PLACEHOLDER_MOTD;
	public static String		ADDITIONAL_PLACEHOLDER_ONLINE;
	public static String		ADDITIONAL_PLACEHOLDER_ONLINE_NUMBER;
	...
	public void loadDefaults() {
		...
		ADDITIONAL_PLACEHOLDER_LEADER_NAME = "%leader_name%";
		ADDITIONAL_PLACEHOLDER_LEADER_UUID = "%leader_uuid%";
		ADDITIONAL_PLACEHOLDER_LIST_RANK = "%list_{rank}%";
		ADDITIONAL_PLACEHOLDER_LIST_RANK_NUMBER = "%list_{rank}_number%";
		ADDITIONAL_PLACEHOLDER_LIST_RANK_ONLINE = "%list_{rank}_online%";
		ADDITIONAL_PLACEHOLDER_MOTD = "%motd%";
		ADDITIONAL_PLACEHOLDER_ONLINE = "%online%";
		ADDITIONAL_PLACEHOLDER_ONLINE_NUMBER = "%online_number%";
	...
	public void loadConfiguration(ConfigurationAdapter confAdapter) {
		...
		ADDITIONAL_PLACEHOLDER_LEADER_NAME = confAdapter.getString("additional.placeholders.leader-name", ADDITIONAL_PLACEHOLDER_LEADER_NAME);
		ADDITIONAL_PLACEHOLDER_LEADER_UUID = confAdapter.getString("additional.placeholders.leader-uuid", ADDITIONAL_PLACEHOLDER_LEADER_UUID);
		ADDITIONAL_PLACEHOLDER_LIST_RANK = confAdapter.getString("additional.placeholders.list-rank", ADDITIONAL_PLACEHOLDER_LIST_RANK);
		ADDITIONAL_PLACEHOLDER_LIST_RANK_NUMBER = confAdapter.getString("additional.placeholders.list-rank-number", ADDITIONAL_PLACEHOLDER_LIST_RANK_NUMBER);
		ADDITIONAL_PLACEHOLDER_LIST_RANK_ONLINE = confAdapter.getString("additional.placeholders.list-rank-online", ADDITIONAL_PLACEHOLDER_LIST_RANK_ONLINE);
		ADDITIONAL_PLACEHOLDER_MOTD = confAdapter.getString("additional.placeholders.motd", ADDITIONAL_PLACEHOLDER_MOTD);
		ADDITIONAL_PLACEHOLDER_ONLINE = confAdapter.getString("additional.placeholders.online", ADDITIONAL_PLACEHOLDER_ONLINE);
		ADDITIONAL_PLACEHOLDER_ONLINE_NUMBER = confAdapter.getString("additional.placeholders.online-number", ADDITIONAL_PLACEHOLDER_ONLINE_NUMBER);
